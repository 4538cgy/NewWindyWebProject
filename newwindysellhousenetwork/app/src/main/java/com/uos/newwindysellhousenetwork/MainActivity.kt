package com.uos.newwindysellhousenetwork
...
import com.uos.newwindysellhousenetwork.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.activityMainWebview.loadUrl("http://신바람.net/main/index.html")
